...
$studioPython = if ($env:GSSTUDIO_GSPLAT_PYTHON) { $env:GSSTUDIO_GSPLAT_PYTHON } else { Join-Path $studioAppRoot '.venv-gsplat\Scripts\python.exe' }
...
$studioArgs = @('-m', 'prototypes.tk_studio.studio')
