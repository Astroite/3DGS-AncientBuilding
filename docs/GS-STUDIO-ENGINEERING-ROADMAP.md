...
更新：2026-09-22。本文规划 APP 原位升级的工程顺序，不是已经实施的架构或运行说明。项目阶段、需求与验收见[项目路线图](GS-STUDIO-PROJECT-ROADMAP.md)；现行命令和边界以[工作手册](CURRENT-WORKFLOW.md)及[维护说明](MAINTENANCE.md)为准。
