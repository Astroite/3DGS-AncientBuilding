"""Dependency check views shared by the GS-Studio GUI and the ``gsstudio`` CLI.

:mod:`gsstudio.application.doctor` owns the checks themselves. This module only turns their
