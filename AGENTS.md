...
操作 Capture、Run、重建或训练前，先读 [当前工作手册](docs/CURRENT-WORKFLOW.md)。开发和脚本清单见 [维护说明](docs/MAINTENANCE.md)。这两份文件是现行说明，不从工作区历史归档提取默认运行命令。
...
- 分段可训练与全路线覆盖独立。实际片段人工验收前不自动开始全量，不自动将 gsplat 提升为默认。
